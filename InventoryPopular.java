...
public class InventoryPopular {
    ...
    InventoryPopular(Statement stmt, JPanel fr) {
        ...
        refresh_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String[] headers = {"SKUs", "Usage", "Popularity"};

                // 2D list to contain each row
                List<List<Object>> data = new ArrayList<List<Object>>();
               // SKUs.sort((o2, o1)
               //       -> o1.amount.intValue()- o2.amount.intValue());
                Collections.sort(SKUs, (o1, o2) -> Float.compare(o2.amount, o1.amount));
                int count = 0;
